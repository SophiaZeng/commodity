...
<BODY>
	...
	<TD>
		<a href="${pageContext.request.contextPath }/customer_deleteCus.action?cid=${customer.cid }">删除</a>
		<a href="${pageContext.request.contextPath }/customer_showCus.action?cid=${customer.cid }">修改</a>
	</TD>
				</TR>
				...
				<%-- <s:iterator value="list" var="cus">
					<TR
						...
						<TD>
							<s:property value="#cus.custLinkman"/>
						</TD>
						<TD>
